'''this program error because contain bug syntax'''
...
def encryptMessage(message, cipherKey, alphabet):
    ...
    for currentCharacter in uppercaseMessage:
        ...
        newPosition = position + cipherKey                                  #error in this line
...
keterangan : 
- terdapat bug pada line 31, perlu merubah type file "cipherKey" menjadi "integer"
'''